...
<body>
	<form id="tiedot">
		<table>
			<thead>
				<tr>
					<th colspan="5" class="oikealle"><span id="takaisin">Takaisin asiakaslistaan</span></th>
				</tr>
				<tr>
					<th>Etunimi</th>
					<th>Sukunimi</th>
			...
			<tbody>
				<tr>
					...
					<td><input type="submit" id="tallenna" value="Lisää asiakas"></td>
				</tr>
			</tbody>
		</table>
	</form>
	...
	$(document).ready(function() {
		...
		$("#tiedot").validate({
			...
			messages : {
				...
				sposti : {
					required : "Arvo puuttuu",
					email : "Ei ole kelvollinen sähköposti"
				}
			},
